...
const WeGuaranteCard = ({ title, logo }: WeGuaranteeCardType) => {
  return (
    <section className="mt-5 flex flex-row sm:flex-col items-center gap-2">
      <div className="sm:min-w-[200px] sm:mx-2 sm:min-h-[200px] min-w-[65px] min-h-[65px] hover:bg-problack transition-all bg-problue flex items-center justify-center">
